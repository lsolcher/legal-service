...
export const action = async ({ request }) => {
    ...
    const prompt = `Analysiere den folgenden Gesetzestext basierend auf diesen Prinzipien der digitaltauglichen Regelungsgestaltung:\n${principles.join("\n")}\n\nGesetzestext:\n${content}\n\nBitte identifiziere gut gestaltete Aspekte und Bereiche, die verbessert werden könnten. Fasse dich kurz. Wenn der Gesetzestext an sich keinen Sinn ergibt, dann antworte entsprechend ohne Prinzipienauswertung.`;
